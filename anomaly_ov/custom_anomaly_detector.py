...
def build_ov_anomaly_detector(
    ...
    Args:
        ...
        mm_projector_type: Type of multimodal projector 
                          (default: "mlp2x_gelu" - 2-layer MLP with GELU)
        mm_hidden_size: Hidden size of vision encoder output (default: 1152 for SigLip)
        hidden_size: Hidden size for projector output (default: 896 for Qwen2-0.5B,
                     use 3584 for 7B models)
    ...
    print(f"  - MM projector: {mm_projector_type}")
    print(f"  - Hidden sizes: {mm_hidden_size} -> {hidden_size}")
